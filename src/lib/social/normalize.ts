...
import { resolveClicks } from "@/lib/metrics";
import {
...
export function normalizeInstagramPost(
  ...
  return {
    ...
    metrics: {
      ...
      shares: 0,
      saves: 0,
      clicks: resolveClicks(impressions, "instagram", record),
    },
  };
}
...
export function normalizeFacebookPost(
  ...
  return {
    ...
    metrics: {
      ...
      shares,
      saves: 0,
      clicks: resolveClicks(impressions, "facebook", record),
    },
  };
}
...
export function normalizeXPost(
  ...
  return {
    ...
    metrics: {
      ...
      shares,
      saves: 0,
      clicks: resolveClicks(impressions, "x", record),
    },
  };
}
...
export function normalizeYouTubePost(
  ...
  return {
    ...
    metrics: {
      ...
      shares: 0,
      saves: 0,
      clicks: resolveClicks(impressions, "youtube", record),
    },
  };
}
